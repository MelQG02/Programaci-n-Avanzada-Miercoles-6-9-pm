...
namespace pruebaCaso1.Data
{
    ...
    {
        public ClaseEfContext(
            DbContextOptions<ClaseEfContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Habitacion>(entity =>
            {
                ...
                entity.Property(e => e.CodigoDeHabitacion)
                    .HasMaxLength(7)
                    .IsRequired();

                entity.Property(e => e.NombreDeHabitacion)
                    .HasMaxLength(30)
                    .IsRequired();
                ...
                entity.Property(e => e.EncargadoDeLimpieza)
                    .HasMaxLength(100)
                    .IsRequired();

                entity.Property(e => e.CostoDeLimpieza)
                    .HasColumnType("decimal(18, 2)")
                    .IsRequired();

                entity.Property(e => e.CostoDeReserva)
                    .HasColumnType("decimal(18, 2)")
                    .IsRequired();
            ...
            {
                entity.HasKey(e => e.Id)
                    .HasName("PK_Reservaciones");

                entity.ToTable("Reservaciones");

                entity.Property(e => e.NombreDeLaPersona)
                    .HasMaxLength(150)
                    .IsRequired();
